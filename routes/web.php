...
Route::post('/order-item/increase-to-cart','ProductItemController@updatetocart');
Route::post('/order-item/deduct-to-cart','ProductItemController@deducttocart');
...
Route::group(['middleware' => 'auth'], function () {
    //admin panel route
        ...
        //Inclusive Meal
        Route::get('admin-ecom/inclusive-meal/settings','InclusiveMealController@inclusiveSettings');
        Route::post('admin-ecom/inclusive-meal/settings','InclusiveMealController@inclusiveSettingsSave');
        ...
        Route::get('admin-ecom/inclusive/product-delete/{id}','InclusiveMealController@destroy');
        //Inclusive Meal
