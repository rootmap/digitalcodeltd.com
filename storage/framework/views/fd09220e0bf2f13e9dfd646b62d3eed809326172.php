...
<script>
        ...
        function loadCart(data)
        {
            ...
            { 
                $(".tax-space").children("div:eq(1)").children("span:eq(0)").html('0.00'); 
            }
                        ...
                        // console.log(row.price);
                            ...
                            if(row.inclusiveMeal==1)
                            {
                                ...
                                if($(".mini-cart-list").children('#cart-row-'+index).length>0)
                                {
                                    ...
                                    $(".mini-cart-list").children('#cart-row-'+index).children('input').val(row.qty);
                                ...
                                else
                                {
                                    ...
                                    var dataSTR ='';
                                    var dataSTRExtras ='';
                                    dataSTR+='<li id="cart-row-'+index+'" class="inclusiveMenuPureClass'+row.data.id+'" data-index="'+index+'" data-inclusive="1" item-id="'+row.data.id+'" data-id="'+row.raw_flavour+'">';
                                    dataSTR+='   <div class="cart-body">';
                                    dataSTR+='      <a class="cart-item-highlight" href="javascript:void(0);" style="font-size:11px !important;"><span style="color:#b57c00">'+row.data.name+'</span>';
                                        ...
                                        dataSTRExtras+='            </div>';
                                        dataSTRExtras+='        </div>';
                                    dataSTR+='      <br><span class="cartQUANIT" style="color:#777;">'+row.qty+'</span> X <span style="color:#777;"> £</span><span style="color:#777;">'+parseFloat(row.unit_price).toFixed(2)+'</span> = <span style="color:#777;"> £</span><span class="cartItemPricePR" style="color:#777;">'+parseFloat(row.price).toFixed(2)+'</span></a>';
                                    dataSTR+=dataSTRExtras;
                                    dataSTR+='   </div>';
                                    dataSTR+='  <input style="width: 35px; text-align:center;position: absolute; right:24px; top: 0;" type="text" name="quantity[]" id="quantity_'+index+'" value="'+row.qty+'">' +
                                        ' <a style="background-color: #b57c00; right: 0px; color: #fff !important; padding: 3px 2px 2px 2px; border-radius:50%;height: 20px; width: 20px; top:1px; font-size:10px;" class="remove" href="javascript:delRowLi(&apos;'+index+'&apos;);"><i class="fa fa-times" title="Remove"></i></a>' +
                                        '<a style="background-color: #d9534f; color: #fff !important; padding: 2px; border-radius:50%;height: 20px; width: 20px; right:0px;" class="increase increase_cart_item" href="javascript:void(0);"><i class="fa fa-plus" title="Increase"></i></a>' +
                                        '<a style="background-color: #d9534f; color: #fff !important; padding: 2px; border-radius:50%;height: 20px; width: 20px; right: 30px;" class="decrease decrease_cart_item" href="javascript:void(0);"><i class="fa fa-minus" title="Decrease"></i></a>';
                                    dataSTR+='</li>';
                                    //return dataSTR;
        ...
        function updateLayoutOne(obj)
        {
            ...
            if(obj.sub_cat_name)
            {
             ...
             var rowID="cart-row-"+parseObj.id;
             $(".mini-cart-list").children("#"+rowID).children(".cartQUANIT").html(obj.qty);
             $(".mini-cart-list").children("#"+rowID).children("input").val(obj.qty);
        ...
        function minilayoutOne(obj)
        {
            ...
            var dataSTR ='';
        	var dataSTRExtras ='';
        	    dataSTR+='<li id="cart-row-'+parseObj.id+'" style="min-height: 55px;" class="inclusiveMenuPureClass'+parseObj.id+'" data-index="'+parseObj.id+'" data-inclusive="1" item-id="'+parseObj.id+'" data-id="'+parseObj.id+'">';
                dataSTR+='   <div class="cart-body" style="font-size:11px !important;">';
                if(parseObj.product_level_type==2)
                {
                    dataSTR+='   <a class="cart-item-highlight" href="javascript:void(0);">'+subCatPushName;
                }
                else
                {
                    dataSTR+='   <a class="cart-item-highlight" href="javascript:void(0);">'+subCatPushName+''+parseObj.name;
                }
                ...
                dataSTR+='<br /><span class="cartQUANIT" style="color:#777;">'+obj.qty+'</span> X <span style="color:#777;"> £</span><span style="color:#777;">'+obj.item.price+'</span> = <span style="color:#777;"> £</span><span class="cartItemPricePR" style="color:#777;">'+parseFloat(totalPriceGen).toFixed(2)+'</span></a>';
                dataSTR+=dataSTRExtras;
                dataSTR+='   </div>';
                dataSTR+='  <input style="width: 35px; text-align:center;position: absolute; right:24px; top: 0;" type="text" name="quantity[]" id="quantity_'+parseObj.id+'" value="'+obj.qty+'">' +
                                    ' <a style="background-color: #b57c00; right: 0px; color: #fff !important; padding: 3px 2px 2px 2px; border-radius:50%;height: 20px; width: 20px; top:1px; font-size:10px;" class="remove" href="javascript:delRowLi(&apos;'+parseObj.id+'&apos;);"><i class="fa fa-times" title="Remove"></i></a>' +
                                    '<a style="background-color: #d9534f; color: #fff !important; padding: 2px; border-radius:50%;height: 20px; width: 20px; right:0px;" class="increase increase_cart_item" href="javascript:void(0);"><i class="fa fa-plus" title="Increase"></i></a>' +
                                    '<a style="background-color: #d9534f; color: #fff !important; padding: 2px; border-radius:50%;height: 20px; width: 20px; right: 30px;" class="decrease decrease_cart_item" href="javascript:void(0);"><i class="fa fa-minus" title="Decrease"></i></a>';
                dataSTR+='</li>';
                return dataSTR;
...

        {
            ...
            $(document).ready(function(){
                ...
                {
                    $("#menu_page_category").show();
                    $("#menu_page_category_full").show();
                    $(".order_info_des").show();
                ...
                else
                {
                    ...
                    $("#menu_page_category").hide();
                    $("#menu_page_category_full").hide();
                    $(".order_info_des").hide();
                }
